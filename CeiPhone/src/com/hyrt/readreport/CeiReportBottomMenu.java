...
public class CeiReportBottomMenu extends Fragment implements OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.read_report_bottom_menu,container,false);
	...
	private boolean checkIsLogin(){
		SharedPreferences settings = getActivity().getSharedPreferences("loginInfo",
